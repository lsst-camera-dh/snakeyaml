...
public class Yaml {
    ...
    /**
     * Allow caller to control behavior when duplicate keys are encountered
     * @param flagDuplicates 
     *      If true throw exception when duplicates are seen
     */
    public Yaml(boolean flagDuplicates) {
        this(new Constructor(flagDuplicates), new Representer(), new DumperOptions(), new Resolver());
    }
    ...
    public Yaml(DumperOptions dumperOptions, boolean flagDuplicates) {
        this(new Constructor(flagDuplicates), new Representer(), dumperOptions);
    }
    ...
    public Yaml(Representer representer, boolean flagDuplicates) {
        this(new Constructor(flagDuplicates), representer);
    }
    ...
    public Yaml(Representer representer, DumperOptions dumperOptions, boolean flagDuplicates) {
        this(new Constructor(flagDuplicates), representer, dumperOptions, new Resolver());
    }
