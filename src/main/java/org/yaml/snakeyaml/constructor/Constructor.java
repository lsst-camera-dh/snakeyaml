...
public class Constructor extends SafeConstructor {
    ...
    public Constructor(boolean flagDuplicates) {
      this(Object.class, flagDuplicates);
    }
    ...
    public Constructor(Class<? extends Object> theRoot) {
        this(new TypeDescription(checkRoot(theRoot)), false);
    }

     public Constructor(Class<? extends Object> theRoot, boolean flagDuplicates) {
        this(new TypeDescription(checkRoot(theRoot)), flagDuplicates);
    }
    ...
    public Constructor(TypeDescription theRoot, boolean flagDuplicates) {
        super(flagDuplicates);
        if (theRoot == null) {
